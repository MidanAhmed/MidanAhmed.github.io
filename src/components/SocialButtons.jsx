    ...
    return (
        <div className='flex flex-wrap gap-4 text-base font-bold'>
            <a href="https://github.com/MidanAhmed" target='_blank'>
                <button className="group relative inline-flex border items-center justify-center overflow-hidden rounded-md bg-themed-white dark:bg-themed-black gap-2 px-4 py-2">
